...
const DaimondBox = ({ id, daimond, offer, text, price }) => {
    return (
        <div>
            <div className='daimonCard bg-grau-100  flex  px-3 pt-4 pb-6 cursor-pointer rounded-lg shadow-lg border-2 border-white  shadow-gray-300 text-sm font-semibold text-gray-800 '>
                ...
                <div className='w-full flex space-x-3 justify-between '>
                    <h1>{daimond} {offer ? `+ ${offer}` : ""} {text}</h1>
